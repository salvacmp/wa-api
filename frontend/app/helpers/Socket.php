...
/**
 * WebSocket Helper
 * This file is forked from paragi/PHP-websocket-client
 *
 * @author Simon Rigét https://github.com/paragi
 * @author Salvatore Cahyo <salva@dsgroupmedia.com>
 *
 * @copyright Copyright (c) 2013 Simon Riget
 * @copyright Copyright (c) 2021 Salvatore Cahyo
 *
 * @link https://github.com/paragi/PHP-websocket-client
 *
 */
Class Socket {
    /**
     ...
     * @param int $timeout
     * @param boolean $ssl
     * @param boolean $presistant
     * @param string $path
     *
     */
    function websocket_open(string $host='',int $port=80,array $headers=[],&$error_string='',$timeout=10,$ssl=false, $persistant = false, $path = '/', $context = null){
